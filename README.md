...
- 부리또·난과 커리·마라탕·탕수육·두부덮밥·비건 카레 등 118종의 다양한 후보 메뉴
- 화면 하단에서 현재 추천 가능한 118개 전체 메뉴를 음식권별로 요약하고 점진적 추가 안내
...
접속 주소는 `http://127.0.0.1:8000`, 상태 확인은 `http://127.0.0.1:8000/health`입니다. 별도 조건을 선택하지 않아도 첫 화면과 로컬 의미 분석 추천은 동작합니다.
